...
# Replace with your AD Domain - aksadmin1@atingupta2005gmail.onmicrosoft.com
AKS_AD_AKSADMIN1_USER_OBJECT_ID=$(az ad user create \
  --display-name "AKS Admin1" \
  --user-principal-name aksadmin1@atingupta2005gmail.onmicrosoft.com \
  --password @AKSDemo123 \
...
Username: aksadmin1@atingupta2005gmail.onmicrosoft.com
Password: @AKSDemo123
```
...
```
# Set SSH KEY Path
AKS_SSH_KEY_LOCATION=/Users/atingupta2005/.ssh/aks-prod-sshkeys/aksprodsshkey.pub
